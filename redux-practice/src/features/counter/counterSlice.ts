...
export const counterSlice = createSlice({
  ...
  reducers: {
    ...
    increment: state => {
      ...
      // ** What this mumbo jumbo is saying is that we don't need to worry 
      // about creating clones of state because it automatically does it for us
      state.value += 1;
    },
    decrement: state => {
      state.value -= 1;
    ...
    // **Payload just means to say the information that is put in 
